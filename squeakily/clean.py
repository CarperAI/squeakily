...
# %% auto 0
__all__ = ['normalize_whitespace', 'remove_empty_lines', 'replace_urls', 'replace_dates', 'replace_email', 'replace_phone',
           'replace_ip', 'replace_credit_card', 'replace_ssn']
