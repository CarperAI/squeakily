...
# %% auto 0
__all__ = ['logger', 'MINHASH_SEED', 'NON_ALPHA', 'lsh', 'dup_ids', 'check_char_repetition', 'check_flagged_words',
           'check_perplexity', 'check_language', 'check_word_number', 'check_stop_word_ratio', 'minhash_dedup']
